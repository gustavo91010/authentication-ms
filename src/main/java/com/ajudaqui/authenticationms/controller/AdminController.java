...
public class AdminController {
    ...
    public String dashboard(Model model, Principal principal) {
        ...
        List<UsersAppData> userApps = usersAppDataRepository.findByUserEmail(email);
        
        List<Map<String, Object>> apps = userApps.stream()
        ...
        if (queueNames != null && !queueNames.isEmpty() && sqsClient != null) {
            ...
            for (String name : names) {
                ...
                try {
                    String queueUrl = sqsClient.getQueueUrl(GetQueueUrlRequest.builder().queueName(name.trim()).build()).queueUrl();
