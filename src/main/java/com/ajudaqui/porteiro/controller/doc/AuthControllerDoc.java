...
import com.ajudaqui.porteiro.response.LoginResponse;
...
public interface AuthControllerDoc {
  ...
  @Operation(summary = "Realizar login", description = "Autentica o usuário e retorna JWT e dados de acesso.")
  @ApiResponses({
  ...
  @Operation(summary = "Confirmar token", description = "Confirma o token enviado para validação de conta, validando o registro ")
  @ApiResponses({
  ...
  ResponseEntity<?> confirmToken(
      ...
      @Parameter(description = "Token de confirmação recebido por email", example = "123456") @RequestParam String token);
