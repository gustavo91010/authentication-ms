...
import com.ajudaqui.porteiro.config.security.jwt.JwtUtils;
import com.ajudaqui.porteiro.controller.doc.ApplicationsControllerDoc;
import com.ajudaqui.porteiro.dto.*;
import com.ajudaqui.porteiro.entity.Applications;
import com.ajudaqui.porteiro.service.ApplicationsService;
...
public class ApplicationController implements ApplicationsControllerDoc {
  ...
  @Override
  public ResponseEntity<HttpAplications> register(
      String authorization,
      ApplicationDto applicationDto) {
    Applications register = applicationsService.register(authorization, applicationDto);
    return ResponseEntity.ok(new HttpAplications(register));
  }

  @Override
  @PreAuthorize("hasRole('ROLE_MODERATOR')")
  public ResponseEntity<HttpAplications> getByAppName(
      String jwtToken,
      String appName) {
  ...
  @Override
  @PreAuthorize("hasRole('ROLE_MODERATOR')")
  public ResponseEntity<HttpAplications> getById(
      String jwtToken,
